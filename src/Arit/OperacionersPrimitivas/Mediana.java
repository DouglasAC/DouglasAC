...
public class Mediana extends Funcion {
    ...
    public Mediana(String identificador, LinkedList<Parametro> parametros, LinkedList<NodoAst> sentencias, int fila, int columna) {
    ...
    public double mediana(ArrayList<Object> numeros, boolean trim, Object tval) {
        ...
        if (nuevos.size() > 0) {
            ...
            if (par % 2 == 0.0) {
                ...
                return (nuevos.get(mitad - 1) + nuevos.get(mitad)) / 2;
            } else {
                //impar
                int mitad = par / 2;
                return nuevos.get(mitad);
            }
        } else {
