 ...
 * @author ddani
 */
public class LlamadaAcceso extends Expresion {

    Expresion expresion;
    LinkedList<NodoAcceso> accesos;

    public LlamadaAcceso(Expresion expresion, LinkedList<NodoAcceso> accesos, int fila, int columna) {
        super(fila, columna);
    ...
    public Object getValorImplicito(Entorno en) {
        try {
            Object estructura = expresion.getValorImplicito(en);
            if (estructura != null) {
                ...
                Informacion.Informacion.agregarError(new ErrorAr("Semantico", "La llamada a la funcion no retorno una estructura", this.fila, this.columna));
            }
        } catch (Exception e) {
            Informacion.Informacion.agregarError(new ErrorAr("Semantico", "Error al ejecutar llamada acceso a", this.fila, this.columna));
        }
        return null;
    }
    ...
    public NodoDot generarDot(int numero) {
        ...
        cuerpo += principal + "[label=\"Llamada_Acceso\"];\n";
        NodoDot llamada = this.expresion.generarDot(numero);
        cuerpo += llamada.Cuerpo;
        numero = llamada.Numero;
        cuerpo += principal + " -> " + llamada.Nombre + ";\n";
