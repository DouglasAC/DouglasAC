    ...
    public Object getValorImplicito(Entorno en) {
        try {
            ...
            if (glob.existeFuncion(identificador)) {
                ...
                if (fun instanceof Array || fun instanceof Length || fun instanceof List || fun instanceof Matrix || fun instanceof Ncol || fun instanceof Nrow || fun instanceof Remove || fun instanceof Round || fun instanceof StringLength || fun instanceof ToLowerCase || fun instanceof ToUpperCase || fun instanceof Trunk || fun instanceof TypeOf) {
                    fun.fila = fila;
                    fun.columna = columna;
                }
                ...
                } else if (fun instanceof Imprimir) {
                    Imprimir im = (Imprimir) fun;
                    if (this.valores.size() == 1) {
                        im.valor = this.valores.get(0);
                        im.fila = fila;
                        im.columna = columna;
                        return im.ejecutar(en);
                    } else {
